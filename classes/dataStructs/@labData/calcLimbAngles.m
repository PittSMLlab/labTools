...
if trialData.markerData.isaLabel('RKNEx') && trialData.markerData.isaLabel('LKNEx')
    LkneePos2D=trialData.getMarkerData({['LKNE' orientation.foreaftAxis],['LKNE' orientation.updownAxis]});
    LkneePos2D=[orientation.foreaftSign* LkneePos2D(:,1),orientation.updownSign*LkneePos2D(:,2)];
    RkneePos2D=trialData.getMarkerData({['RKNE' orientation.foreaftAxis],['RKNE' orientation.updownAxis]});
...
elseif trialData.markerData.isaLabel('RKNEEx') && trialData.markerData.isaLabel('LKNEEx')  
    LkneePos2D=trialData.getMarkerData({['LKNEE' orientation.foreaftAxis],['LKNEE' orientation.updownAxis]});
    LkneePos2D=[orientation.foreaftSign* LkneePos2D(:,1),orientation.updownSign*LkneePos2D(:,2)];
    RkneePos2D=trialData.getMarkerData({['RKNEE' orientation.foreaftAxis],['RKNEE' orientation.updownAxis]});
    RkneePos2D=[orientation.foreaftSign* RkneePos2D(:,1),orientation.updownSign*RkneePos2D(:,2)];
else
...
if trialData.markerData.isaLabel('RTOEx') && trialData.markerData.isaLabel('LTOEx')
    LtoePos2D=trialData.getMarkerData({['LTOE' orientation.foreaftAxis],['LTOE' orientation.updownAxis]});
    LtoePos2D=[orientation.foreaftSign* LtoePos2D(:,1),orientation.updownSign*LtoePos2D(:,2)];
    RtoePos2D=trialData.getMarkerData({['RTOE' orientation.foreaftAxis],['RTOE' orientation.updownAxis]});
...
if trialData.markerData.isaLabel('RHEEx') && trialData.markerData.isaLabel('LHEEx')
    LheelPos2D=trialData.getMarkerData({['LHEE' orientation.foreaftAxis],['LHEE' orientation.updownAxis]});
    LheelPos2D=[orientation.foreaftSign* LheelPos2D(:,1),orientation.updownSign*LheelPos2D(:,2)];
    RheelPos2D=trialData.getMarkerData({['RHEE' orientation.foreaftAxis],['RHEE' orientation.updownAxis]});
