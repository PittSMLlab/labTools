...
%
%   Note: Current problem - sampling needs to be uniform, but
%         when we alignEvents that can no longer be the case
%         (because event times have natural variability, its
%         alignment implies that we'll have non-uniform sampling)
%
