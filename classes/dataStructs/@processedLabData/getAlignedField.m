...
%   alignmentLengths) aligns the specified field data to the provided gait
%   events with specified resampling lengths
%
%   Inputs:
%       field - name of the data field to align
%       events - cell array of event labels for alignment
%       alignmentLengths - vector specifying the number of samples between
%                          each pair of events
%
%   Outputs:
...
[alignedField, bad] = ...
    this.(field).align(this.gaitEvents, events, alignmentLengths);
end
