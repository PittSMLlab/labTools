function out = errorProofInfobeta(handles,ignoreErrors)
...
%     end
    ...
    if isnan(out.year) || out.year<1 || out.year>500000
    ...
    if isnan(out.DOByear) || out.DOByear<1 || out.year>3000000 %seems like an appropriate range...
