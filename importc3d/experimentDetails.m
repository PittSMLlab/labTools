...
switch expDescrip
    ...
    case {'0002: Old'}
        ...
        set(handles.numofconds,'string','6')    
        
        %condition names
        set(handles.condName1,'string','OG base')        
        set(handles.condName2,'string','TM base')        
        set(handles.condName3,'string','Gradual adaptation')
        set(handles.condName4,'string','Split condition')
        set(handles.condName5,'string','OG post')
        set(handles.condName6,'string','TM post')

        
        
        %condition descriptions
        set(handles.description1,'string','8m walk for 10 min')        
        set(handles.description2,'string','600 strides 1.125m/s')        
        set(handles.description3,'string','600 gradual until 1.5:.75')
        set(handles.description4,'string','300 at split 2:1')
        set(handles.description5,'string','8m walk for 10 min')
        set(handles.description6,'string','600 strides 1.125 m/s')
        
        
        %trial numbers for each condition
        set(handles.trialnum1,'string','1:10')
        set(handles.trialnum2,'string','11:14')
        set(handles.trialnum3,'string','15:18')
        set(handles.trialnum4,'string','19:20')
        set(handles.trialnum5,'string','21:30')
        set(handles.trialnum6,'string','31:34')
        
        %check appropriate OG conditions
        set(handles.OGcheck1,'value',1)
        set(handles.OGcheck5,'value',1)
