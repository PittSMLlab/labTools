        ...
        if ~isempty(sync)           % if sync signals present, proceed
            ...
            if isnan(E1) || isnan(E2) || ...
                ...
                warning('loadTrials:syncMismatchHigh', ...
                    ...
                    'exceeds the threshold of %.0f%%. ' ...
                    'Synchronization quality may be poor. ' ...
                    'Inspect the sync figure for trial %d before ' ...
                    'deciding whether to proceed.'], ...
                    tr, 100*E1, 100*E2, ...
                    100*syncMismatchThreshold, tr);
                h = plotSyncFigure(tr, refSync, sync, ...
                    gain1, gain2, lagInSamplesA, lagInSamples, ...
                    E1, E2, EMGfrequency, secondFile, ...
                    syncPlotDuration);
                s = inputdlg( ...
                ...
                switch s{1}
                    ...
                    case {'n', 'N', 'no'}
                        error( ...
                            ...
                            ['[Trial %d] Could not synchronize ' ...
                            'EMG data. Processing stopped at ' ...
                            'user request after sync mismatch ' ...
                            'of PC1: %.2f%%, PC2: %.2f%%.'], ...
                            tr, 100*E1, 100*E2);
                end
            end
