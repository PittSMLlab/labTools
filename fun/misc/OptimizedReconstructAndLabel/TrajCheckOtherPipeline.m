...
subject = 'C3S24';
trialPath = 'Z:\Nathan\ViconNexusReconstructAndLabel\Vicon\C3S24_S1\Trial16(2)';
...
% % Run the optimized pipeline function (assumes this saves the trial)
% fprintf('Running optimized pipeline...\n');
% dataMotion.reconstructAndLabelTrial(trialPath);  
% markerGaps = dataMotion.extractMarkerGapsTrial(trialPath);
% dataMotion.fillSmallMarkerGapsSpline(markerGaps, trialPath);
% 
% pause(5);
% 
% trajData = struct();
