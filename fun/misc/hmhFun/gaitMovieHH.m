...
Xlim = [min([Marker.LAnkle.X(start:stop); ...
             Marker.RAnkle.X(start:stop)]) - 200, ...
        max([Marker.LMT.X(start:stop); ...
             Marker.RMT.X(start:stop)]) + 200];
Ylim = [min([Marker.LAnkle.Y(start:stop); ...
             Marker.RAnkle.Y(start:stop)]) - 200, ...
        max([Marker.LAnkle.Y(start:stop); ...
             Marker.RAnkle.Y(start:stop)]) + 200];
Zlim = [min([Marker.LMT.Z(start:stop); ...
             Marker.RMT.Z(start:stop)]) - 200, ...
        max([Marker.LPelvis.Z(start:stop); ...
             Marker.RPelvis.Z(start:stop)]) + 200];
...
set(gca, 'XLim',             Xlim, ...
         ...
         'CameraPosition',   [-1213.04 -8746.45 1140.87], ...
         'CameraTarget',     [-780.782 -498.523 441.085], ...
