    ...
    for i = 1:numStrides - 1
        ...
        if ~isempty(striderS) && ~all(striderS == striderS(1)) && ...
            ...
            if std(striderS, 'omitnan') > 0.01 && ...
                ...
                [FyBS(i), FyBSsum(i), FyPS(i), FyPSsum(i), FyBSmax(i), ...
                    FyBSmax_ABS(i), ~, FyPSmax(i), ~, ImpactMagS(i)] = ...
                    ComputeLegForceParameters(striderS, levelOfInterest,...
                    flipB, ['Epoch: ' trialData.name ', Stride#: ' ...
                    num2str(i) '; SlowLeg']);
            end

            % Vertical and medial-lateral force measures
            FzS(i) = -1 * mean(filteredGRF.split(SHS, STO) ...
                .getDataAsTS([slowleg 'Fz']).Data, 'omitnan') ...
                / normalizer;
            FxS(i) = mean(filteredGRF.split(SHS, STO) ...
                .getDataAsTS([slowleg 'Fx']).Data, 'omitnan') ...
                / normalizer;
            FzSmax(i) = -1 * min(filteredGRF.split(SHS, STO) ...
                .getDataAsTS([slowleg 'Fz']).Data, [], 'omitnan') ...
                / normalizer;
            FxSmax(i) = min(filteredGRF.split(SHS, STO) ...
                .getDataAsTS([slowleg 'Fx']).Data, [], 'omitnan') ...
                / normalizer;
        end
        ...
        if ~isempty(striderF) && ~all(striderF == striderF(1)) && ...
            ...
            if std(striderF, 'omitnan') > 0.01 || ...
                ...
                [FyBF(i), FyBFsum(i), FyPF(i), FyPFsum(i), FyBFmax(i), ...
                    FyBFmax_ABS(i), ~, FyPFmax(i), ~, ImpactMagF(i)] = ...
                    ComputeLegForceParameters(striderF, levelOfInterest,...
                    flipB, ['Epoch: ' trialData.name ', Stride#: ' ...
                    num2str(i) '; FastLeg']);
            end
            ...
            FzF(i) = -1 * mean(filteredGRF.split(FHS, FTO2) ...
                .getDataAsTS([fastleg 'Fz']).Data, 'omitnan') ...
                / normalizer;
            FxF(i) = mean(filteredGRF.split(FHS, FTO2) ...
                .getDataAsTS([fastleg 'Fx']).Data, 'omitnan') ...
                / normalizer;
            FzFmax(i) = -1 * min(filteredGRF.split(FHS, FTO2) ...
                .getDataAsTS([fastleg 'Fz']).Data, [], 'omitnan') ...
                / normalizer;
            FxFmax(i) = max(filteredGRF.split(FHS, FTO2) ...
                .getDataAsTS([fastleg 'Fx']).Data, [], 'omitnan') ...
                / normalizer;
        end
    end
