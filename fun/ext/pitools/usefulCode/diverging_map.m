...
%XYZTORGB Convert XYZ to sRGB with gamma correction.
...
% sRGB gamma correction (IEC 61966-2-1) for perceptual uniformity.
% Assumed by Adobe Photoshop, Windows color management, and OpenGL.
...
% Clip colors. Ideally we would use a perceptually closest projection,
% but simple clipping works well in practice.
maxVal = max([r g b]);
if maxVal > 1.0
    r = r / maxVal;
    g = g / maxVal;
...
% Inverse sRGB gamma correction (IEC 61966-2-1).
